            ...
            <div className="relative z-10 w-full h-full flex flex-col justify-end p-8 md:p-20 pointer-events-none">
              <div className="place-content-inner max-w-4xl">
                ...
                <div className="overflow-hidden pt-2">
                  <h1 className="font-display text-4xl md:text-[clamp(2.5rem,5vw,6rem)] uppercase text-white leading-[0.9] mb-4 drop-shadow-2xl break-words hyphens-auto w-full">
                    {place.name}
                  </h1>
                </div>
