...
const MilestoneCard: React.FC<MilestoneCardProps> = ({ milestone, index, onClick, total }) => {
  ...
  return (
    <div 
      ref={containerRef} 
      className="sticky top-0 h-[100dvh] w-full overflow-hidden flex flex-col justify-center bg-brand-light border-b border-brand-dark/5"
...
const Milestones: React.FC<MilestonesProps> = ({ content }) => {
  ...
  return (
    <section ref={containerRef} className="relative w-full bg-brand-light">
