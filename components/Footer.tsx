          ...
          <div className="md:w-1/3 grid grid-cols-2 gap-8">
             <div>
                ...
                <ul className="space-y-4 font-serif text-base md:text-lg text-white/60">
                    <li className="hover:text-white transition-colors cursor-pointer" onClick={scrollToTop}>Home</li>
                    <li className="hover:text-white transition-colors cursor-pointer">Memories</li>
                    <li className="hover:text-white transition-colors cursor-pointer">Future</li>
                    <li className="hover:text-white transition-colors cursor-pointer">Proposal</li>
                </ul>
             </div>
